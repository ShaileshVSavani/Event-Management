    ...
    <div data-aos="fade-up" className="card service_card bg-base-100 shadow-xl">
      ...
      <div className="card-body relative  bg-sky-100 gap-4 py-10">
        ...
        <div className="card-actions justify-start">
          <Link to={`/singleService/${id}`}><button className="btn bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-md shadow-lg">View Details</button></Link>
        </div>
      </div>
    </div>
  );
